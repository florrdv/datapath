...
DP_OPERATIONS = [
('zero' , pattern((('op', 'zero'), ('rd', register())), can_have_label=True),                                                       "zero rd            -->  $rd := 0",                          lambda m, params : '0000'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+'000'+'000' ),
('not'  , pattern((('op', 'not'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "not rd rs          -->  $rd := ! $rs",                      lambda m, params : '0000'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'001' ),
('inv'  , pattern((('op', 'inv'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "inv rd rs          -->  $rd := - $rs",                      lambda m, params : '0000'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'010' ),
('sll'  , pattern((('op', 'sll'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "sll rd rs          -->  $rd := $rs << 2",                   lambda m, params : '0000'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'011' ),
('srl'  , pattern((('op', 'srl'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "srl rd rs          -->  $rd := $rs >> 2",                   lambda m, params : '0000'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'100' ),
('sla'  , pattern((('op', 'sla'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "sla rd rs          -->  $rd := $rs * 2",                    lambda m, params : '0000'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'101' ),
('sra'  , pattern((('op', 'sra'),  ('rd', register()), ('rs', register())), can_have_label=True),                                   "sra rd rs          -->  $rd := $rs / 2",                    lambda m, params : '0000'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'110' ),
('cp'   , pattern((('op', 'cp'),   ('rd', register()), ('rs', register())), can_have_label=True),                                   "cp rd rs           -->  $rd := $rs",                        lambda m, params : '0000'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+'111' ),
('or'   , pattern((('op', 'or'),   ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "or rd rs rt        -->  $rd := $rs | $rt",                  lambda m, params : '0001'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
...
('add'  , pattern((('op', 'add'),  ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "add rd rs rt       -->  $rd := $rs + $rt",                  lambda m, params : '0011'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('sub'  , pattern((('op', 'sub'),  ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "sub rd rs rt       -->  $rd := $rs - $rt",                  lambda m, params : '0100'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('lt'   , pattern((('op', 'lt'),   ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "lt rd rs rt        -->  $rs < $rt ? $rd := 1 : $rd := 0",   lambda m, params : '0101'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('gt'   , pattern((('op', 'gt'),   ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "gt rd rs rt        -->  $rs > $rt ? $rd := 1 : $rd := 0",   lambda m, params : '0110'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('eq'   , pattern((('op', 'eq'),   ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "eq rd rs rt        -->  $rs = $rt ? $rd := 1 : $rd := 0",   lambda m, params : '0111'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('neq'  , pattern((('op', 'neq'),  ('rd', register()), ('rs', register()), ('rt', register())), can_have_label=True),               "neq rd rs rt       -->  $rs != $rt ? $rd := 1 : $rd := 0",  lambda m, params : '1000'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rt'),REGISTER_ADDRESS_SIZE)) ),
('lw'   , pattern((('op', 'lw'),   ('rd', register()), ('rs', register()), ('imm', uintegerpattern())), can_have_label=True),       "lw rd rs uimm      -->  $rd := MEM[$rs + imm]",             lambda m, params : '1001'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(uint2bin(m.group('imm'),3)) ),
('sw'   , pattern((('op', 'sw'),   ('rd', register()), ('rs', register()), ('imm', uintegerpattern())), can_have_label=True),       "sw rd rs uimm      -->  MEM[$rs + imm] := $rd",             lambda m, params : '1010'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(uint2bin(m.group('imm'),3)) )
]

# extra full data path operations
# (name, parse_pattern, help_string, compile_function)
FULL_DP_OPERATIONS = [
('ori'  , pattern((('op', 'ori'),  ('rd', register()), ('imm', binarypattern(6))), can_have_label=True),                            "ori rd imm     -->  rd := rd | imm",               lambda m, params : '1011'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+m.group('imm') ),
('ori'  , pattern((('op', 'ori'),  ('rd', register()), ('imm', uintegerpattern())), can_have_label=True),                           "ori rd imm     -->  rd := rd | imm",               lambda m, params : '1011'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(uint2bin(m.group('imm'),6)) ),
('lui'  , pattern((('op', 'lui'),  ('rd', register()), ('imm', binarypattern(6))), can_have_label=True),                            "lui rd imm     -->  rd := imm << 6",               lambda m, params : '1100'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+m.group('imm') ),
('lui'  , pattern((('op', 'lui'),  ('rd', register()), ('imm', uintegerpattern())), can_have_label=True),                           "lui rd imm     -->  rd := imm << 6",               lambda m, params : '1100'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(uint2bin(m.group('imm'),6)) ),
...
('jr'   , pattern((('op', 'jr'),   ('rd', register()), ('imm', binarypattern(6))), can_have_label=True),                            "jr rd imm       -->  pc := rd+imm",                lambda m, params : '1110'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+m.group('imm')),
('jr'   , pattern((('op', 'jr'),   ('rd', register()), ('imm', integerpattern())), can_have_label=True),                            "jr rd imm       -->  pc := rd+imm",                lambda m, params : '1110'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),6)) ),
('jr'   , pattern((('op', 'jr'),   ('rd', register()), ('to', labelpattern())), can_have_label=True),                               "jr rd imm       -->  pc := rd+imm",                lambda m, params : '1110'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(label2bin(m.group('to'),6,params[1])) ),
('j'    , pattern((('op', 'j'),    ('addr', binarypattern(8))), can_have_label=True),                                               "j addr          -->  pc := addr",                  lambda m, params : '1111'+m.group('addr')+'0' ),
('j'    , pattern((('op', 'j'),    ('addr', uintegerpattern())), can_have_label=True),                                              "j addr          -->  pc := addr",                  lambda m, params : '1111'+str(uint2bin(m.group('addr'),8))+'0' ),
('j'    , pattern((('op', 'j'),    ('to', labelpattern())), can_have_label=True),                                                   "j addr          -->  pc := addr",                  lambda m, params : '1111'+str(label2bin(m.group('to'),8,params[1]))+'0' ),
('jal'  , pattern((('op', 'jal'),  ('addr', binarypattern(8))), can_have_label=True),                                               "jal addr        -->  r7 := pc+1 ; pc := addr",     lambda m, params : '1111'+m.group('addr')+'1' ),
('jal'  , pattern((('op', 'jal'),  ('addr', uintegerpattern())), can_have_label=True),                                              "jal addr        -->  r7 := pc+1 ; pc := addr",     lambda m, params : '1111'+str(uint2bin(m.group('addr'),8))+'1' ),
('jal'  , pattern((('op', 'jal'),  ('to', labelpattern())), can_have_label=True),                                                   "jal addr        -->  r7 := pc+1 ; pc := addr",     lambda m, params : '1111'+str(label2bin(m.group('to'),8,params[1]))+'1' ),
]
