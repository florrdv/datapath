...
('lw'   , pattern((('op', 'lw'),   ('rd', register()), ('rs', register()), ('imm', integerpattern())), can_have_label=True),        "lw rd rs uimm      -->  $rd := MEM[$rs + imm]",             lambda m, params : '1001'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),3)) ),
('sw'   , pattern((('op', 'sw'),   ('rd', register()), ('rs', register()), ('imm', integerpattern())), can_have_label=True),        "sw rd rs uimm      -->  MEM[$rs + imm] := $rd",             lambda m, params : '1010'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),3)) )
]
...
('ori'  , pattern((('op', 'ori'),  ('rd', register()), ('imm', uintegerpattern())), can_have_label=True),                           "ori rd imm     -->  rd := rd | imm",               lambda m, params : '1011'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),6)) ),
...
('lui'  , pattern((('op', 'lui'),  ('rd', register()), ('imm', uintegerpattern())), can_have_label=True),                           "lui rd imm     -->  rd := imm << 6",               lambda m, params : '1100'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),6)) ),
...
('j'    , pattern((('op', 'j'),    ('addr', uintegerpattern())), can_have_label=True),                                              "j addr          -->  pc := addr",                  lambda m, params : '1111'+str(int2bin(m.group('addr'),8))+'0' ),
...
('jal'  , pattern((('op', 'jal'),  ('addr', uintegerpattern())), can_have_label=True),                                              "jal addr        -->  r7 := pc+1 ; pc := addr",     lambda m, params : '1111'+str(int2bin(m.group('addr'),8))+'1' ),
